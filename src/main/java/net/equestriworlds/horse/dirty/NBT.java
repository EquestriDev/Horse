...
public final class NBT {
    private final Field fieldCraftItemStackHandle;

    public NBT() {
        try {
            this.fieldCraftItemStackHandle = CraftItemStack.class.getDeclaredField("handle");
            this.fieldCraftItemStackHandle.setAccessible(true);
        } catch (Exception e) {
     ...
     * Maps and Lists.
     */
    public NBTBase toTag(Object value) {
        if (value == null) {
            return null;
    ...
    public Map<String, Object> getItemTag(org.bukkit.inventory.ItemStack bukkitItem) {
        try {
            if (!(bukkitItem instanceof CraftItemStack)) return null;
            CraftItemStack obcItem = (CraftItemStack)bukkitItem;
            ItemStack nmsItem = (ItemStack)this.fieldCraftItemStackHandle.get(obcItem);
     ...
     * reasons.
     */
    public org.bukkit.inventory.ItemStack setItemTag(org.bukkit.inventory.ItemStack bukkitItem, Map<String, Object> json) {
        try {
    ...
    public Map<String, Object> getBlockTag(org.bukkit.block.BlockState bukkitBlockState) {
    ...
    public boolean setBlockTag(org.bukkit.block.Block bukkitBlock, Map<String, Object> json) {
        CraftWorld craftWorld = (CraftWorld)bukkitBlock.getWorld();
        TileEntity tileEntity = craftWorld.getTileEntityAt(bukkitBlock.getX(), bukkitBlock.getY(), bukkitBlock.getZ());
    ...
    public Map<String, Object> getEntityTag(org.bukkit.entity.Entity entity) {
    ...
    public void setEntityTag(org.bukkit.entity.Entity entity, Map<String, Object> json) {
        Entity nmsEntity = ((CraftEntity)entity).getHandle();
        NBTTagCompound tag = (NBTTagCompound)toTag(json);
        nmsEntity.f(tag);
    }
    ...
    public Optional<Object> accessItemNBT(org.bukkit.inventory.ItemStack bukkitItem, boolean create) {
        try {
    ...
    public CraftItemStack newCraftItemStack(org.bukkit.Material bukkitMaterial) {
        return CraftItemStack.asCraftCopy(new org.bukkit.inventory.ItemStack(bukkitMaterial));
    }

    public CraftItemStack toCraftItemStack(org.bukkit.inventory.ItemStack bukkitItem) {
    ...
    public void setNBT(Optional<Object> opt, String key, Object value) {
    ...
    public Optional<Object> getNBT(Optional<Object> opt, String key) {
        if (!opt.isPresent()) throw new NullPointerException("Tag cannot be null");
        if (!(opt.get() instanceof NBTTagCompound)) throw new IllegalArgumentException("Expected tag compound: " + opt.get().getClass().getName());
        NBTTagCompound tag = (NBTTagCompound)opt.get();
    ...
    public Optional<Object> getNBT(Optional<Object> opt, int index) {
        if (!opt.isPresent()) throw new NullPointerException("Tag cannot be null");
    ...
    public Object fromNBT(Optional<Object> opt) {
